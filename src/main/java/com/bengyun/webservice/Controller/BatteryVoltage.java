...
public class BatteryVoltage {
	 ...
	 * */
	@RequestMapping(value="/batteryVoltage/{publisher}", method= RequestMethod.GET)
	public List<QueryMeanValueModel> getData(
		...
		List<QueryMeanValueModel> aBatteryVoltageList = influxDbUtils.queryAsMean(
				publisher,
				"battery_voltage",
				startTime,
				endTime,
				groupTime,
				fill);
		return aBatteryVoltageList;
	}
	@RequestMapping(value="/batteryVoltage/{publisher}/{starttime}", method= RequestMethod.GET)
	public List<QueryMeanValueModel> getData(
			@PathVariable String publisher,
	...
	@RequestMapping(value="/batteryVoltage/{publisher}/{starttime}/{endtime}", method= RequestMethod.GET)
	public List<QueryMeanValueModel> getData(
			@PathVariable String publisher,
			@PathVariable String starttime,
	...
	@RequestMapping(value="/batteryVoltage/{publisher}/{starttime}/{endtime}/{grouptime}/{fill}", method= RequestMethod.GET)
	public List<QueryMeanValueModel> getData(
			@PathVariable String publisher,
			@PathVariable String starttime,
			@PathVariable String endtime,
